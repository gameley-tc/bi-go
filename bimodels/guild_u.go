...
func NewLogGuildU(logReason *LogReason, logType bigo.LogEnumGuildU, guildId int) *LogGuildU {
	return &LogGuildU{LogReason: logReason, LogType: logType, GuildId: guildId}
}
